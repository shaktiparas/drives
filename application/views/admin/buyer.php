                            ...
                            <div class="card-body pt-3 px-0">
                                ...
                                <div class="table-responsive">
                                    <table class="table header-border table-responsive-sm">
                                        ...
                                        <tbody>
                                            <?php
                                            foreach($activeBuyer as $buyers)
                                            {
                                            
                                            ?>
                                            <tr>
                                                <td><?php echo $buyers['Username']; ?></td>
                                                <td><?php echo $buyers['Address']; ?></td>
                                                <td><?php echo $buyers['PhoneNumber']; ?></td>
                                                <td><?php echo $buyers['Email']; ?></td>
                                                <td><a type="submit" class="btn detail-view" href="profile/<?php echo $buyers['id'];?>">Detail</a></td>
                                            </tr>
                                            <?php
